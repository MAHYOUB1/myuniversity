  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      content: 'تعلن عمادة القبول والتسجيل عن بدء التسجيل للفصل الصيفي للعام الجامعي 2024-2025 وذلك ابتداءً من يوم الأحد الموافق 5 مايو 2024 وحتى يوم الخميس الموافق 15 مايو 2025. على جميع الطلاب الراغبين في التسجيل مراجعة المرشد الأكاديمي قبل التسجيل.',
      date: '1 مايو 2025',
    ...
    },
    {
      ...
      content: 'تنظم كلية الهندسة مؤتمراً علمياً بعنوان "التقنيات الحديثة في الهندسة وتطبيقاتها" وذلك يوم السبت الموافق 25 مايو 2025 في قاعة المؤتمرات الكبرى بالجامعة. الدعوة عامة لجميع الطلاب وأعضاء هيئة التدريس والمهتمين.',
      date: '15 أبريل 2025',
      category: 'event',
      read: true
    },
